...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('gigs_category', 'description', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'Category.description'
        db.alter_column('gigs_category', 'description', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
