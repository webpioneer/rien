...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Gig.longitude'
        db.alter_column('gigs_gig', 'longitude', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'Gig.latitude'
        db.alter_column('gigs_gig', 'latitude', self.gf('django.db.models.fields.CharField')(max_length=25))

    def backwards(self, orm):

        # Changing field 'Gig.longitude'
        db.alter_column('gigs_gig', 'longitude', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'Gig.latitude'
        db.alter_column('gigs_gig', 'latitude', self.gf('django.db.models.fields.CharField')(max_length=15))
