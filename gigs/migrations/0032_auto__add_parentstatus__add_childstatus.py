...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ParentStatus'
        db.create_table('gigs_parentstatus', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
        db.send_create_signal('gigs', ['ParentStatus'])

        # Adding model 'ChildStatus'
        db.create_table('gigs_childstatus', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('parent_status', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gigs.ParentStatus'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('gigs', ['ChildStatus'])

        # Adding M2M table for field status on 'Application'
        db.create_table('gigs_application_status', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('application', models.ForeignKey(orm['gigs.application'], null=False)),
            ('childstatus', models.ForeignKey(orm['gigs.childstatus'], null=False))
        ))
        db.create_unique('gigs_application_status', ['application_id', 'childstatus_id'])


    def backwards(self, orm):
        # Deleting model 'ParentStatus'
        db.delete_table('gigs_parentstatus')

        # Deleting model 'ChildStatus'
        db.delete_table('gigs_childstatus')

        # Removing M2M table for field status on 'Application'
        db.delete_table('gigs_application_status')
    ...
    models = {
        ...
        'gigs.applier': {
            ...
            'profile_picture': ('django.db.models.fields.files.ImageField', [], {'default': "'static/media/company_logos/.thumbnails/employer_default.png'", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        'gigs.childstatus': {
            ...
            'parent_status': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['gigs.ParentStatus']"}),
