...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Application.message_ptr'
        db.delete_column('gigs_application', 'message_ptr_id')

        # Adding field 'Application.message'
        db.add_column('gigs_application', 'message',
                      self.gf('django.db.models.fields.related.OneToOneField')(default='', to=orm['django_messages.Message'], unique=True, primary_key=True),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Application.message_ptr'
        raise RuntimeError("Cannot reverse this migration. 'Application.message_ptr' and its values cannot be restored.")
        # Deleting field 'Application.message'
        db.delete_column('gigs_application', 'message_id')
    ...
    models = {
        ...
        'gigs.application': {
            ...
            'message': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['django_messages.Message']", 'unique': 'True', 'primary_key': 'True'})
        },
        'gigs.applier': {
