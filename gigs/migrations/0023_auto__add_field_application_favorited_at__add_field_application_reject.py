...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Application.favorited_at'
        db.add_column('gigs_application', 'favorited_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Application.rejected_at'
        db.add_column('gigs_application', 'rejected_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Application.printed_at'
        db.add_column('gigs_application', 'printed_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Application.favorited_at'
        db.delete_column('gigs_application', 'favorited_at')

        # Deleting field 'Application.rejected_at'
        db.delete_column('gigs_application', 'rejected_at')

        # Deleting field 'Application.printed_at'
        db.delete_column('gigs_application', 'printed_at')
