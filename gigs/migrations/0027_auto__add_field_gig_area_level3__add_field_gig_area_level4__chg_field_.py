...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Gig.area_level3'
        db.add_column('gigs_gig', 'area_level3',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Gig.area_level4'
        db.add_column('gigs_gig', 'area_level4',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Gig.area_level2'
        db.alter_column('gigs_gig', 'area_level2', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'Gig.area_level1'
        db.alter_column('gigs_gig', 'area_level1', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

    def backwards(self, orm):
        # Deleting field 'Gig.area_level3'
        db.delete_column('gigs_gig', 'area_level3')

        # Deleting field 'Gig.area_level4'
        db.delete_column('gigs_gig', 'area_level4')


        # Changing field 'Gig.area_level2'
        db.alter_column('gigs_gig', 'area_level2', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Gig.area_level1'
        db.alter_column('gigs_gig', 'area_level1', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
