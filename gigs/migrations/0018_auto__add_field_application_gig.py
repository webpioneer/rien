...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Application.gig'
        db.add_column('gigs_application', 'gig',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['gigs.Gig']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Application.gig'
        db.delete_column('gigs_application', 'gig_id')
