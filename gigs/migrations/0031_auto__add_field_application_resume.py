...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Application.resume'
        db.add_column('gigs_application', 'resume',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['gigs.Resume']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Application.resume'
        db.delete_column('gigs_application', 'resume_id')
