...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Application.gig'
        db.alter_column('gigs_application', 'gig_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gigs.Gig'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Application.gig'
        raise RuntimeError("Cannot reverse this migration. 'Application.gig' and its values cannot be restored.")
