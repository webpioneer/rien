...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ChildStatus.parent_status'
        db.delete_column('gigs_childstatus', 'parent_status_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ChildStatus.parent_status'
        raise RuntimeError("Cannot reverse this migration. 'ChildStatus.parent_status' and its values cannot be restored.")
