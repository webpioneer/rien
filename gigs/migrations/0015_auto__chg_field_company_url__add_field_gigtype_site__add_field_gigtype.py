...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('gigs_company', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
        # Adding field 'GigType.site'
        db.add_column('gigs_gigtype', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sites.Site']),
                      keep_default=False)

        # Adding field 'GigType.title'
        db.add_column('gigs_gigtype', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500),
                      keep_default=False)

        # Adding field 'GigType.slug'
        db.add_column('gigs_gigtype', 'slug',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Company.url'
        db.alter_column('gigs_company', 'url', self.gf('django.db.models.fields.URLField')(default='', max_length=200))
        # Deleting field 'GigType.site'
        db.delete_column('gigs_gigtype', 'site_id')

        # Deleting field 'GigType.title'
        db.delete_column('gigs_gigtype', 'title')

        # Deleting field 'GigType.slug'
        db.delete_column('gigs_gigtype', 'slug')
