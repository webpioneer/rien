...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Gig.area_level1'
        db.add_column('gigs_gig', 'area_level1',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Gig.area_level2'
        db.add_column('gigs_gig', 'area_level2',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Gig.area_level1'
        db.delete_column('gigs_gig', 'area_level1')

        # Deleting field 'Gig.area_level2'
        db.delete_column('gigs_gig', 'area_level2')
