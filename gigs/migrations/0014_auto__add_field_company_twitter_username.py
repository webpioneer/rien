...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Company.twitter_username'
        db.add_column('gigs_company', 'twitter_username',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Company.twitter_username'
        db.delete_column('gigs_company', 'twitter_username')
