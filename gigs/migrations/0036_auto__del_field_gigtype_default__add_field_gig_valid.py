...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GigType.default'
        db.delete_column('gigs_gigtype', 'default')

        # Adding field 'Gig.valid'
        db.add_column('gigs_gig', 'valid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'GigType.default'
        db.add_column('gigs_gigtype', 'default',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Gig.valid'
        db.delete_column('gigs_gig', 'valid')
