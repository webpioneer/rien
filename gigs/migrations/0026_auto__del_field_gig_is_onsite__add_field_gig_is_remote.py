...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Gig.is_onsite'
        db.delete_column('gigs_gig', 'is_onsite')

        # Adding field 'Gig.is_remote'
        db.add_column('gigs_gig', 'is_remote',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Gig.is_onsite'
        db.add_column('gigs_gig', 'is_onsite',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Gig.is_remote'
        db.delete_column('gigs_gig', 'is_remote')
