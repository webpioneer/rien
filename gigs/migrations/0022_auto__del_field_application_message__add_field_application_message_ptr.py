...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Application.message_ptr'
        db.add_column('gigs_application', 'message_ptr',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Application.message'
        raise RuntimeError("Cannot reverse this migration. 'Application.message' and its values cannot be restored.")
