...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Company.profile_picture'
        db.add_column('gigs_company', 'profile_picture',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Company.profile_picture'
        db.delete_column('gigs_company', 'profile_picture')
