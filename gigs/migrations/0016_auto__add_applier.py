...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Applier'
        db.create_table('gigs_applier', (
            ...
            ('profile_picture', self.gf('django.db.models.fields.files.ImageField')(default='static/media/company_logos/.thumbnails/employer_default.png', max_length=255, null=True, blank=True)),
            ('twitter_username', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ...
            ('is_relocation', self.gf('django.db.models.fields.NullBooleanField')(default=True, null=True, blank=True)),
            ('is_looking', self.gf('django.db.models.fields.NullBooleanField')(default=True, null=True, blank=True)),
        ...
        db.send_create_signal('gigs', ['Applier'])


    def backwards(self, orm):
        # Deleting model 'Applier'
        db.delete_table('gigs_applier')
