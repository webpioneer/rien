...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('gigs_application', (
        ...
        db.send_create_signal('gigs', ['Application'])

        # Deleting field 'Applier.resume'
        db.delete_column('gigs_applier', 'resume')


    def backwards(self, orm):
        # Deleting model 'Application'
        db.delete_table('gigs_application')


        # User chose to not deal with backwards NULL issues for 'Applier.resume'
        raise RuntimeError("Cannot reverse this migration. 'Applier.resume' and its values cannot be restored.")
