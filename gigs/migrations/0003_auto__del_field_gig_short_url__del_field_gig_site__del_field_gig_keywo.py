...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Gig.short_url'
        db.delete_column('gigs_gig', 'short_url')

        # Deleting field 'Gig.site'
        db.delete_column('gigs_gig', 'site_id')

        # Deleting field 'Gig.keywords_string'
        db.delete_column('gigs_gig', 'keywords_string')

        # Deleting field 'Gig.in_sitemap'
        db.delete_column('gigs_gig', 'in_sitemap')

        # Deleting field 'Gig.id'
        db.delete_column('gigs_gig', 'id')

        # Deleting field 'Gig.title'
        db.delete_column('gigs_gig', 'title')

        # Deleting field 'Gig.status'
        db.delete_column('gigs_gig', 'status')

        # Deleting field 'Gig.description'
        db.delete_column('gigs_gig', 'description')

        # Deleting field 'Gig.expiry_date'
        db.delete_column('gigs_gig', 'expiry_date')

        # Deleting field 'Gig.slug'
        db.delete_column('gigs_gig', 'slug')

        # Deleting field 'Gig.gen_description'
        db.delete_column('gigs_gig', 'gen_description')

        # Deleting field 'Gig._meta_title'
        db.delete_column('gigs_gig', '_meta_title')

        # Deleting field 'Gig.publish_date'
        db.delete_column('gigs_gig', 'publish_date')

        # Removing M2M table for field categories on 'Gig'
        db.delete_table('gigs_gig_categories')

        # Adding M2M table for field gig_categories on 'Gig'
        db.create_table('gigs_gig_gig_categories', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('gig', models.ForeignKey(orm['gigs.gig'], null=False)),
            ('category', models.ForeignKey(orm['gigs.category'], null=False))
        ))
        db.create_unique('gigs_gig_gig_categories', ['gig_id', 'category_id'])


        # Changing field 'Gig.product'
        db.alter_column('gigs_gig', 'product_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['shop.Product'], unique=True, primary_key=True))

    def backwards(self, orm):
        # Adding field 'Gig.short_url'
        db.add_column('gigs_gig', 'short_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Gig.site'
        db.add_column('gigs_gig', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sites.Site']),
                      keep_default=False)

        # Adding field 'Gig.keywords_string'
        db.add_column('gigs_gig', 'keywords_string',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'Gig.in_sitemap'
        db.add_column('gigs_gig', 'in_sitemap',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Gig.id'
        db.add_column('gigs_gig', 'id',
                      self.gf('django.db.models.fields.AutoField')(default=0, primary_key=True),
                      keep_default=False)

        # Adding field 'Gig.title'
        db.add_column('gigs_gig', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500),
                      keep_default=False)

        # Adding field 'Gig.status'
        db.add_column('gigs_gig', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)

        # Adding field 'Gig.description'
        db.add_column('gigs_gig', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Gig.expiry_date'
        db.add_column('gigs_gig', 'expiry_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Gig.slug'
        db.add_column('gigs_gig', 'slug',
                      self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Gig.gen_description'
        db.add_column('gigs_gig', 'gen_description',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Gig._meta_title'
        db.add_column('gigs_gig', '_meta_title',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Gig.publish_date'
        db.add_column('gigs_gig', 'publish_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)
        ...
        # Removing M2M table for field gig_categories on 'Gig'
        db.delete_table('gigs_gig_gig_categories')


        # Changing field 'Gig.product'
        db.alter_column('gigs_gig', 'product_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['shop.Product'], unique=True))
