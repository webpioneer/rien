...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('faqs_faqcategory', (
        ...
        db.send_create_signal('faqs', ['Faq'])

        # Adding M2M table for field categories on 'Faq'
        db.create_table('faqs_faq_categories', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('faq', models.ForeignKey(orm['faqs.faq'], null=False)),
            ('faqcategory', models.ForeignKey(orm['faqs.faqcategory'], null=False))
        ))
        db.create_unique('faqs_faq_categories', ['faq_id', 'faqcategory_id'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Faq'
        db.delete_table('faqs_faq')

        # Removing M2M table for field categories on 'Faq'
        db.delete_table('faqs_faq_categories')
    ...
    models = {
        ...
        'faqs.faqcategory': {
            'Meta': {'ordering': "('title',)", 'object_name': 'FaqCategory'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sites.Site']"}),
            'slug': ('django.db.models.fields.CharField', [], {'max_length': '2000', 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '500'})
