...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field gig_types on 'GigSearch'
        db.delete_table('searchapp_gigsearch_gig_types')
    ...
    def backwards(self, orm):
        ...
        # Adding M2M table for field gig_types on 'GigSearch'
        db.create_table('searchapp_gigsearch_gig_types', (
        ...
        db.create_unique('searchapp_gigsearch_gig_types', ['gigsearch_id', 'gigtype_id'])
    ...
    models = {
        ...
        'searchapp.gigsearch': {
            ...
            'contract': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'expiry_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'freelance': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'full_time': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
