...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResumeSearch.subscribed_user'
        db.add_column('searchapp_resumesearch', 'subscribed_user',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)

        # Adding field 'GigSearch.subscribed_user'
        db.add_column('searchapp_gigsearch', 'subscribed_user',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field subscribed_user on 'GigSearch'
        db.delete_table('searchapp_gigsearch_subscribed_user')


    def backwards(self, orm):
        # Deleting field 'ResumeSearch.subscribed_user'
        db.delete_column('searchapp_resumesearch', 'subscribed_user')

        # Deleting field 'GigSearch.subscribed_user'
        db.delete_column('searchapp_gigsearch', 'subscribed_user')

        # Adding M2M table for field subscribed_user on 'GigSearch'
        db.create_table('searchapp_gigsearch_subscribed_user', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('gigsearch', models.ForeignKey(orm['searchapp.gigsearch'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('searchapp_gigsearch_subscribed_user', ['gigsearch_id', 'user_id'])
    ...
    models = {
        ...
        'searchapp.gigsearch': {
            ...
            'subscribed_user': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
