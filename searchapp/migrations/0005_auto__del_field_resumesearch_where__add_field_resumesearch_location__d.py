...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ResumeSearch.where'
        db.delete_column('searchapp_resumesearch', 'where')

        # Adding field 'ResumeSearch.location'
        db.add_column('searchapp_resumesearch', 'location',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'GigSearch.where'
        db.delete_column('searchapp_gigsearch', 'where')

        # Adding field 'GigSearch.location'
        db.add_column('searchapp_gigsearch', 'location',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ResumeSearch.where'
        db.add_column('searchapp_resumesearch', 'where',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ResumeSearch.location'
        db.delete_column('searchapp_resumesearch', 'location')

        # Adding field 'GigSearch.where'
        db.add_column('searchapp_gigsearch', 'where',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'GigSearch.location'
        db.delete_column('searchapp_gigsearch', 'location')
