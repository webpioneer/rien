...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BaseSearch'
        db.create_table('searchapp_basesearch', (
        ...
        db.send_create_signal('searchapp', ['BaseSearch'])

        # Adding model 'ResumeSearch'
        db.create_table('searchapp_resumesearch', (
            ('basesearch_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['searchapp.BaseSearch'], unique=True, primary_key=True)),
        ))
    ...
    def backwards(self, orm):
        # Deleting model 'BaseSearch'
        db.delete_table('searchapp_basesearch')
    ...
    models = {
        ...
        'searchapp.basesearch': {
            'Meta': {'object_name': 'BaseSearch'},
        ...
        'searchapp.gigsearch': {
            'Meta': {'object_name': 'GigSearch', '_ormbases': ['searchapp.BaseSearch']},
            'basesearch_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['searchapp.BaseSearch']", 'unique': 'True', 'primary_key': 'True'}),
            'is_onsite': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'})
        },
        'searchapp.resumesearch': {
            'Meta': {'object_name': 'ResumeSearch', '_ormbases': ['searchapp.BaseSearch']},
            'basesearch_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['searchapp.BaseSearch']", 'unique': 'True', 'primary_key': 'True'})
        },
        'sites.site': {
